...
static jsi::Value __hostFunction_NativeReactNativeFeatureFlagsCxxSpecJSI_cxxNativeAnimatedRemoveJsSync(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  return static_cast<NativeReactNativeFeatureFlagsCxxSpecJSI *>(&turboModule)->cxxNativeAnimatedRemoveJsSync(
    rt
  );
}
...
static jsi::Value __hostFunction_NativeReactNativeFeatureFlagsCxxSpecJSI_enableIOSTextBaselineOffsetPerLine(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  return static_cast<NativeReactNativeFeatureFlagsCxxSpecJSI *>(&turboModule)->enableIOSTextBaselineOffsetPerLine(
    rt
  );
}
...
static jsi::Value __hostFunction_NativeReactNativeFeatureFlagsCxxSpecJSI_enableMainQueueCoordinatorOnIOS(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  return static_cast<NativeReactNativeFeatureFlagsCxxSpecJSI *>(&turboModule)->enableMainQueueCoordinatorOnIOS(
    rt
  );
}
...
static jsi::Value __hostFunction_NativeReactNativeFeatureFlagsCxxSpecJSI_enableVirtualViewDebugFeatures(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  return static_cast<NativeReactNativeFeatureFlagsCxxSpecJSI *>(&turboModule)->enableVirtualViewDebugFeatures(
    rt
  );
}
static jsi::Value __hostFunction_NativeReactNativeFeatureFlagsCxxSpecJSI_enableVirtualViewRenderState(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  return static_cast<NativeReactNativeFeatureFlagsCxxSpecJSI *>(&turboModule)->enableVirtualViewRenderState(
    rt
  );
}
static jsi::Value __hostFunction_NativeReactNativeFeatureFlagsCxxSpecJSI_enableVirtualViewWindowFocusDetection(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  return static_cast<NativeReactNativeFeatureFlagsCxxSpecJSI *>(&turboModule)->enableVirtualViewWindowFocusDetection(
    rt
  );
}
...
static jsi::Value __hostFunction_NativeReactNativeFeatureFlagsCxxSpecJSI_hideOffscreenVirtualViewsOnIOS(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  return static_cast<NativeReactNativeFeatureFlagsCxxSpecJSI *>(&turboModule)->hideOffscreenVirtualViewsOnIOS(
    rt
  );
}
...
static jsi::Value __hostFunction_NativeFantomCxxSpecJSI_startSurface(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  return static_cast<NativeFantomCxxSpecJSI *>(&turboModule)->startSurface(
    rt,
    count <= 0 ? throw jsi::JSError(rt, "Expected argument in position 0 to be passed") : args[0].asNumber(),
    count <= 1 ? throw jsi::JSError(rt, "Expected argument in position 1 to be passed") : args[1].asNumber(),
    count <= 2 ? throw jsi::JSError(rt, "Expected argument in position 2 to be passed") : args[2].asNumber(),
...
static jsi::Value __hostFunction_NativeFantomCxxSpecJSI_enqueueNativeEvent(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  static_cast<NativeFantomCxxSpecJSI *>(&turboModule)->enqueueNativeEvent(
    rt,
    ...
    count <= 3 || args[3].isUndefined() ? std::nullopt : std::make_optional(args[3].asNumber()),
    count <= 4 || args[4].isUndefined() ? std::nullopt : std::make_optional(args[4].asBool())
  );
  return jsi::Value::undefined();
}
static jsi::Value __hostFunction_NativeFantomCxxSpecJSI_enqueueScrollEvent(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  static_cast<NativeFantomCxxSpecJSI *>(&turboModule)->enqueueScrollEvent(
    rt,
    count <= 0 ? throw jsi::JSError(rt, "Expected argument in position 0 to be passed") : jsi::Value(rt, args[0]),
    count <= 1 ? throw jsi::JSError(rt, "Expected argument in position 1 to be passed") : args[1].asObject(rt)
  );
...
static jsi::Value __hostFunction_NativeFantomCxxSpecJSI_enqueueModalSizeUpdate(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  static_cast<NativeFantomCxxSpecJSI *>(&turboModule)->enqueueModalSizeUpdate(
    rt,
    count <= 0 ? throw jsi::JSError(rt, "Expected argument in position 0 to be passed") : jsi::Value(rt, args[0]),
    count <= 1 ? throw jsi::JSError(rt, "Expected argument in position 1 to be passed") : args[1].asNumber(),
    count <= 2 ? throw jsi::JSError(rt, "Expected argument in position 2 to be passed") : args[2].asNumber()
...
static jsi::Value __hostFunction_NativeFantomCxxSpecJSI_takeMountingManagerLogs(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  return static_cast<NativeFantomCxxSpecJSI *>(&turboModule)->takeMountingManagerLogs(
    rt,
    count <= 0 ? throw jsi::JSError(rt, "Expected argument in position 0 to be passed") : args[0].asNumber()
  );
}
static jsi::Value __hostFunction_NativeFantomCxxSpecJSI_getDirectManipulationProps(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  return static_cast<NativeFantomCxxSpecJSI *>(&turboModule)->getDirectManipulationProps(
    rt,
    count <= 0 ? throw jsi::JSError(rt, "Expected argument in position 0 to be passed") : jsi::Value(rt, args[0])
  );
}
static jsi::Value __hostFunction_NativeFantomCxxSpecJSI_getFabricUpdateProps(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  return static_cast<NativeFantomCxxSpecJSI *>(&turboModule)->getFabricUpdateProps(
    rt,
    count <= 0 ? throw jsi::JSError(rt, "Expected argument in position 0 to be passed") : jsi::Value(rt, args[0])
  );
}
...
static jsi::Value __hostFunction_NativeFantomCxxSpecJSI_produceFramesForDuration(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  static_cast<NativeFantomCxxSpecJSI *>(&turboModule)->produceFramesForDuration(
    rt,
    count <= 0 ? throw jsi::JSError(rt, "Expected argument in position 0 to be passed") : args[0].asNumber()
  );
  return jsi::Value::undefined();
}
static jsi::Value __hostFunction_NativeFantomCxxSpecJSI_validateEmptyMessageQueue(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  static_cast<NativeFantomCxxSpecJSI *>(&turboModule)->validateEmptyMessageQueue(
    rt
  );
  return jsi::Value::undefined();
}
...
static jsi::Value __hostFunction_NativeFantomCxxSpecJSI_createShadowNodeReferenceCounter(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  return static_cast<NativeFantomCxxSpecJSI *>(&turboModule)->createShadowNodeReferenceCounter(
    rt,
    count <= 0 ? throw jsi::JSError(rt, "Expected argument in position 0 to be passed") : jsi::Value(rt, args[0])
  );
}
static jsi::Value __hostFunction_NativeFantomCxxSpecJSI_createShadowNodeRevisionGetter(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  return static_cast<NativeFantomCxxSpecJSI *>(&turboModule)->createShadowNodeRevisionGetter(
    rt,
    count <= 0 ? throw jsi::JSError(rt, "Expected argument in position 0 to be passed") : jsi::Value(rt, args[0])
  );
}
static jsi::Value __hostFunction_NativeFantomCxxSpecJSI_saveJSMemoryHeapSnapshot(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  static_cast<NativeFantomCxxSpecJSI *>(&turboModule)->saveJSMemoryHeapSnapshot(
    rt,
    count <= 0 ? throw jsi::JSError(rt, "Expected argument in position 0 to be passed") : args[0].asString(rt)
  );
  return jsi::Value::undefined();
}
static jsi::Value __hostFunction_NativeFantomCxxSpecJSI_forceHighResTimeStamp(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  static_cast<NativeFantomCxxSpecJSI *>(&turboModule)->forceHighResTimeStamp(
    rt,
    count <= 0 || args[0].isNull() || args[0].isUndefined() ? std::nullopt : std::make_optional(args[0].asNumber())
  );
  return jsi::Value::undefined();
}
static jsi::Value __hostFunction_NativeFantomCxxSpecJSI_startJSSamplingProfiler(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  static_cast<NativeFantomCxxSpecJSI *>(&turboModule)->startJSSamplingProfiler(
    rt
  );
  return jsi::Value::undefined();
}
static jsi::Value __hostFunction_NativeFantomCxxSpecJSI_stopJSSamplingProfilerAndSaveToFile(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  static_cast<NativeFantomCxxSpecJSI *>(&turboModule)->stopJSSamplingProfilerAndSaveToFile(
    rt,
    count <= 0 ? throw jsi::JSError(rt, "Expected argument in position 0 to be passed") : args[0].asString(rt)
  );
  return jsi::Value::undefined();
...
NativeFantomCxxSpecJSI::NativeFantomCxxSpecJSI(std::shared_ptr<CallInvoker> jsInvoker)
  ...
  methodMap_["startSurface"] = MethodMetadata {5, __hostFunction_NativeFantomCxxSpecJSI_startSurface};
  methodMap_["stopSurface"] = MethodMetadata {1, __hostFunction_NativeFantomCxxSpecJSI_stopSurface};
  methodMap_["enqueueNativeEvent"] = MethodMetadata {5, __hostFunction_NativeFantomCxxSpecJSI_enqueueNativeEvent};
  methodMap_["enqueueScrollEvent"] = MethodMetadata {2, __hostFunction_NativeFantomCxxSpecJSI_enqueueScrollEvent};
  methodMap_["enqueueModalSizeUpdate"] = MethodMetadata {3, __hostFunction_NativeFantomCxxSpecJSI_enqueueModalSizeUpdate};
  methodMap_["takeMountingManagerLogs"] = MethodMetadata {1, __hostFunction_NativeFantomCxxSpecJSI_takeMountingManagerLogs};
  methodMap_["getDirectManipulationProps"] = MethodMetadata {1, __hostFunction_NativeFantomCxxSpecJSI_getDirectManipulationProps};
  methodMap_["getFabricUpdateProps"] = MethodMetadata {1, __hostFunction_NativeFantomCxxSpecJSI_getFabricUpdateProps};
  ...
  methodMap_["produceFramesForDuration"] = MethodMetadata {1, __hostFunction_NativeFantomCxxSpecJSI_produceFramesForDuration};
  methodMap_["validateEmptyMessageQueue"] = MethodMetadata {0, __hostFunction_NativeFantomCxxSpecJSI_validateEmptyMessageQueue};
  ...
  methodMap_["createShadowNodeReferenceCounter"] = MethodMetadata {1, __hostFunction_NativeFantomCxxSpecJSI_createShadowNodeReferenceCounter};
  methodMap_["createShadowNodeRevisionGetter"] = MethodMetadata {1, __hostFunction_NativeFantomCxxSpecJSI_createShadowNodeRevisionGetter};
  methodMap_["saveJSMemoryHeapSnapshot"] = MethodMetadata {1, __hostFunction_NativeFantomCxxSpecJSI_saveJSMemoryHeapSnapshot};
...
static jsi::Value __hostFunction_NativeFantomTestSpecificMethodsCxxSpecJSI_takeFunctionAndNoop(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  static_cast<NativeFantomTestSpecificMethodsCxxSpecJSI *>(&turboModule)->takeFunctionAndNoop(
    rt,
    count <= 0 ? throw jsi::JSError(rt, "Expected argument in position 0 to be passed") : args[0].asObject(rt).asFunction(rt)
  );
  return jsi::Value::undefined();
...
NativeFantomTestSpecificMethodsCxxSpecJSI::NativeFantomTestSpecificMethodsCxxSpecJSI(std::shared_ptr<CallInvoker> jsInvoker)
  : TurboModule("NativeFantomTestSpecificMethodsCxx", jsInvoker) {
  methodMap_["registerForcedCloneCommitHook"] = MethodMetadata {0, __hostFunction_NativeFantomTestSpecificMethodsCxxSpecJSI_registerForcedCloneCommitHook};
  methodMap_["takeFunctionAndNoop"] = MethodMetadata {1, __hostFunction_NativeFantomTestSpecificMethodsCxxSpecJSI_takeFunctionAndNoop};
}
...
NativeDOMCxxSpecJSI::NativeDOMCxxSpecJSI(std::shared_ptr<CallInvoker> jsInvoker)
  ...
  methodMap_["setNativeProps"] = MethodMetadata {2, __hostFunction_NativeDOMCxxSpecJSI_setNativeProps};
}
...
NativeMutationObserverCxxSpecJSI::NativeMutationObserverCxxSpecJSI(std::shared_ptr<CallInvoker> jsInvoker)
  ...
  methodMap_["unobserveAll"] = MethodMetadata {1, __hostFunction_NativeMutationObserverCxxSpecJSI_unobserveAll};
...
static jsi::Value __hostFunction_NativePerformanceCxxSpecJSI_reportMark(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  static_cast<NativePerformanceCxxSpecJSI *>(&turboModule)->reportMark(
    ...
    count <= 0 ? throw jsi::JSError(rt, "Expected argument in position 0 to be passed") : args[0].asString(rt),
    count <= 1 ? throw jsi::JSError(rt, "Expected argument in position 1 to be passed") : args[1].asNumber(),
    count <= 2 ? throw jsi::JSError(rt, "Expected argument in position 2 to be passed") : jsi::Value(rt, args[2])
  );
  return jsi::Value::undefined();
}
static jsi::Value __hostFunction_NativePerformanceCxxSpecJSI_reportMeasure(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  static_cast<NativePerformanceCxxSpecJSI *>(&turboModule)->reportMeasure(
    ...
    count <= 1 ? throw jsi::JSError(rt, "Expected argument in position 1 to be passed") : args[1].asNumber(),
    count <= 2 ? throw jsi::JSError(rt, "Expected argument in position 2 to be passed") : args[2].asNumber(),
    count <= 3 ? throw jsi::JSError(rt, "Expected argument in position 3 to be passed") : jsi::Value(rt, args[3])
  );
  return jsi::Value::undefined();
}
