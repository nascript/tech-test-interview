...
private:
  ...
  public:
    ...
    void forceHighResTimeStamp(jsi::Runtime &rt, std::optional<double> timeStamp) override {
      static_assert(
          bridging::getParameterCount(&T::forceHighResTimeStamp) == 2,
          "Expected forceHighResTimeStamp(...) to have 2 parameters");

      return bridging::callFromJs<void>(
          rt, &T::forceHighResTimeStamp, jsInvoker_, instance_, std::move(timeStamp));
    }
    void startJSSamplingProfiler(jsi::Runtime &rt) override {
      static_assert(
          bridging::getParameterCount(&T::startJSSamplingProfiler) == 1,
          "Expected startJSSamplingProfiler(...) to have 1 parameters");

      return bridging::callFromJs<void>(
          rt, &T::startJSSamplingProfiler, jsInvoker_, instance_);
    }
    void stopJSSamplingProfilerAndSaveToFile(jsi::Runtime &rt, jsi::String filePath) override {
      static_assert(
